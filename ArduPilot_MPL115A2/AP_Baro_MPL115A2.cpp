...
// Public Methods //////////////////////////////////////////
bool AP_Baro_MPL115A2::init() //Main
{
	//uint8_t buff[22];
...
void AP_Baro_MPL115A2::readCoefficients()
{
	//FIXME repasar
	  ...
	  res = hal.i2c->readRegisters(MPL115A2_ADDRESS, MPL115A2_REGISTER_A0_COEFF_MSB, 8,buf);
		if (res != 0) {
...
void AP_Baro_MPL115A2::getPT(float *P, float *T)
{
	...
	res = hal.i2c->writeRegister(MPL115A2_ADDRESS,MPL115A2_REGISTER_STARTCONVERSION, 0x00);
    if (res != 0) {
        healthy = false;
    }
